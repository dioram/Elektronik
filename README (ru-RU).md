...
- изменения графа связности наблюдений 
...
просто передавая данные по используя [google protocol buffers](https://developers.google.com/protocol-buffers/?hl=en)
и [gRPC](https://grpc.io/).
