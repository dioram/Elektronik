...
namespace Protobuf.Tests
{
    public class ObservationsTests : TestsBase
    {
        ...
        public ObservationsTests()
        {
            ...
            m_map[0].Point.Color = new ColorPb() {R = 255};
            m_map[1].Point.Color = new ColorPb() {G = 255};
            m_map[2].Point.Color = new ColorPb() {B = 255};
            m_map[3].Point.Color = new ColorPb() {R = 255, G = 255};
