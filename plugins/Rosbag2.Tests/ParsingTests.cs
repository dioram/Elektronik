...
namespace Rosbag2.Tests
{
    public class ParsingTests
    {
        ...
        public void PoseStamped()
        {
            ...
            var data = (PoseStamped) MessageParser.Parse(message, topic);
        ...
        public void Odometry()
        {
            ...
            var data = (Odometry) MessageParser.Parse(message, topic);
            var (pos, rot) = data.GetPose().ToUnity();
        ...
        public void PointCloud2()
        {
            ...
            var data = (PointCloud2) MessageParser.Parse(message, topic);
        ...
        public void VisualisationArraySimple()
        {
            ...
            var data = (MarkerArray) MessageParser.Parse(message, topic);
