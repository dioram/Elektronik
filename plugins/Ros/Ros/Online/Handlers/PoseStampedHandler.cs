...
{
    public class PoseStampedHandler : MessageHandler<PoseStamped, SlamTrackedObject>
    {
        public PoseStampedHandler(IContainerTree container, RosSocket socket, string topic) : base(container, socket, topic)
        {
        }
