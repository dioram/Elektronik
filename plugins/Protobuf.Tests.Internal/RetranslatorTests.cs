...
namespace Protobuf.Tests.Internal
{
    public class RetranslatorTests
    {
        ...
        public void Setup()
        {
            ...
            var pointsMapManager = new PointsMapManager(_mockedBuffer.Object, _mockedPointsContainer.Object, null, 
                                                        logger);
            ...
            var trackedObjsMapManager = new TrackedObjsMapManager(_mockedBuffer.Object, 
                                                                  _mockedTrackedObjectsContainer.Object, null,
                                                                  logger);
        ...
        public void PointsTest()
        {
            ...
            Thread.Sleep(50);
            _retranslator.OnItemsUpdated(null,
                                         new UpdatedEventArgs<SlamPoint>(updated.Select(p => p.Apply()).ToArray()));
            Thread.Sleep(50);
        ...
        public void ObservationsTest()
        {
            ...
            var updated = new[]
            {
                new SlamObservationDiff(0, Vector3.zero, Color.red, new Quaternion(6, 2, 1, 0), Array.Empty<int>(),
                                        "123", Path.Combine(Directory.GetCurrentDirectory(), "f.png")),
            ...
            var addCommand =
                new AddCommand<SlamObservation, SlamObservationDiff>(_mockedObservationsContainer.Object, added);
            var updateCommand =
                new UpdateCommand<SlamObservation, SlamObservationDiff>(_mockedObservationsContainer.Object, updated);
            var removeCommand =
                new RemoveCommand<SlamObservation, SlamObservationDiff>(_mockedObservationsContainer.Object, removed);

            _retranslator.OnItemsAdded(null,
                                       new AddedEventArgs<SlamObservation>(added.Select(o => o.Apply()).ToArray()));
            Thread.Sleep(100);
            _retranslator.OnItemsUpdated(null,
                                         new UpdatedEventArgs<SlamObservation>(updated.Select(o => o.Apply())
                                                                                   .ToArray()));
            Thread.Sleep(100);
            _retranslator.OnItemsRemoved(null,
                                         new RemovedEventArgs<SlamObservation>(removed.Select(o => o.Apply())
                                                                                   .ToArray()));
            Thread.Sleep(200);
        ...
        public void TrackedObjectsTest()
        {
            ...
            var addCommand =
                new AddCommand<SlamTrackedObject, SlamTrackedObjectDiff>(_mockedTrackedObjectsContainer.Object, added);
            var updateCommand =
                new UpdateCommand<SlamTrackedObject, SlamTrackedObjectDiff>(_mockedTrackedObjectsContainer.Object,
                                                                            updated);
            var removeCommand =
                new RemoveCommand<SlamTrackedObject, SlamTrackedObjectDiff>(_mockedTrackedObjectsContainer.Object,
                                                                            removed);

            _retranslator.OnItemsAdded(null,
                                       new AddedEventArgs<SlamTrackedObject>(added.Select(o => o.Apply()).ToArray()));
            Thread.Sleep(50);
            _retranslator.OnItemsUpdated(null,
                                         new UpdatedEventArgs<SlamTrackedObject>(updated.Select(o => o.Apply())
                                             .ToArray()));
            Thread.Sleep(50);
            _retranslator.OnItemsRemoved(null,
                                         new RemovedEventArgs<SlamTrackedObject>(removed.Select(o => o.Apply())
                                             .ToArray()));
            Thread.Sleep(100);
        ...
        public void InfinitePlanesTest()
        {
            ...
            Thread.Sleep(50);
            _retranslator.OnItemsUpdated(null,
                                         new UpdatedEventArgs<SlamPlane>(updated.Select(o => o.Apply()).ToArray()));
            Thread.Sleep(50);
            _retranslator.OnItemsRemoved(null,
                                         new RemovedEventArgs<SlamPlane>(removed.Select(o => o.Apply()).ToArray()));
            Thread.Sleep(100);
