...
namespace Protobuf.Tests.Internal.Integration.Online
{
    ...
    public class ObservationsTests : OnlineTestsBase
    {
        ...
        public ObservationsTests() : base(40002)
        {
        ...
        public void Create()
        {
            ...
            var e = new AddedEventArgs<SlamObservation>(_map.Select(p => ((SlamObservationDiff)p).Apply()));
        ...
        public void UpdatePositions()
        {
            ...
            var e = new UpdatedEventArgs<SlamObservation>(_map.Select(p => ((SlamObservationDiff)p).Apply()));
