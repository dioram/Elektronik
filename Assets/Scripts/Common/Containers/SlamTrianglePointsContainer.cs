...
{
    public class SlamTrianglePointsContainer : ISlamContainer<SlamPoint>
    {
        ...
        public SlamTrianglePointsContainer(FastTrianglesCloud cloud)
        {
        ...
        public int Add(SlamPoint point)
        {
            ++m_diff;
            ++m_added;
            m_trianglesCloud.SetPoint(point.id, point.position, point.color);
        ...
        public void ChangeColor(SlamPoint point)
        {
            ...
            m_trianglesCloud.SetPointColor(point.id, point.color);
        ...
        public void Remove(int pointId)
        {
            ...
            m_trianglesCloud.SetPoint(pointId, Vector3.zero, new Color(0, 0, 0, 0));
        ...
        public bool TryGet(SlamPoint point, out SlamPoint current)
        {
            ...
            if (m_trianglesCloud.PointExists(point.id))
            {
