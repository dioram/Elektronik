...
namespace Common.UI
{
    ...
    public class UIContainerTreeElement : MonoBehaviour
    {
        ...
        private readonly List<UIContainerTreeElement> _children = new List<UIContainerTreeElement>();
        ...
        public float GetExpandedSize(bool ignoreSelfExpand = false)
        {
            ...
            {
                res += child.GetExpandedSize(false);
            }
            ...
            while (true)
            {
                lock (Node.Children)
                {
                    ...
                    foreach (var child in newChildren)
                    {
                        ...
                        var treeElement = go.GetComponent<UIContainerTreeElement>();
        ...
        {
            var expanded = GetExpandedSize(false);
