    ...
    public class ClustersManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            foreach (var factory in factories)
            {
                ...
                var panel = go.GetComponent<AlgorithmPanel>();
                panel.Setup(factory);
        ...
        private async void Compute(IClusterizationAlgorithm algorithm, [CanBeNull] IClusterable container, AlgorithmPanel panel)
        {
